...
window.showNiceTitle2 = function ()
{
   ...
   else
   {
      if(evt && evt.target)
      {
         lnk = (evt.target) ? evt.target : e.srcElement;
      }
   }
   if(!lnk) {
      return;
...
//   var baseStyle = "background-color:#EEEEEE;position: absolute;z-index:999;padding: 7px;top: 0px;left: 0px;color: black;font-size: 13px;font-family: Geneva,Arial,Helvetica,sans-serif;opacity:.9;border-style: solid;border-color: #E0E0E0;border-width: 1px"
   var baseStyle = "background-color:#FFFFCC;position: absolute;z-index:999;padding: 4px;top: 0px;left: 0px;color: black;font-size: 11px;font-family: Geneva,Arial,Helvetica,sans-serif;opacity:1;border-style: solid;border-color: #000000;border-width: 1px;-moz-border-radius: 10px";
...
//   pat.appendChild(tnt);  // Put the title text into the <p></p> block
   ...
   STD_WIDTH = 400;  // This code is setting the box width...
   w = STD_WIDTH;
